...
export const INCIDENTS: Record<IncidentId, IncidentDefinition> = {
  electrical_short: { id: "electrical_short", label: "전기 합선", shortLabel: "합선", type: "electrical", nodeId: "bakery_grid", wave: 1, initialSeverity: 2, maxSeverity: 3, spreadAfterMs: 18_000, spreadsTo: ["bakery_fire"], allowedActions: ["cut_power"], requiredProgress: 100, scoreValue: 100, mapPosition: [1144, 166], icon: "generator" },
  bakery_fire: { id: "bakery_fire", label: "빵집 화재", shortLabel: "빵집", type: "fire", nodeId: "bakery", wave: 1, initialSeverity: 2, maxSeverity: 3, spreadAfterMs: 22_000, spreadsTo: ["gas_risk"], allowedActions: ["evacuate", "extinguish", "clear_debris", "firebreak"], requiredProgress: 100, scoreValue: 100, mapPosition: [300, 252], icon: "fire" },
  gas_risk: { id: "gas_risk", label: "가스 폭발 위험", shortLabel: "가스", type: "gas", nodeId: "bakery_gas", wave: 1, initialSeverity: 1, maxSeverity: 3, spreadAfterMs: 18_000, spreadsTo: ["house_fire"], allowedActions: ["shut_gas"], requiredProgress: 100, scoreValue: 100, mapPosition: [1210, 330], icon: "fire" },
  power_flood: { id: "power_flood", label: "발전소 침수", shortLabel: "발전소", type: "flood", nodeId: "power_station", wave: 2, initialSeverity: 2, maxSeverity: 3, spreadAfterMs: 24_000, spreadsTo: ["river_overflow"], allowedActions: ["carry_parts", "repair_power"], requiredProgress: 100, scoreValue: 100, mapPosition: [1010, 240], icon: "generator" },
  river_overflow: { id: "river_overflow", label: "하천 범람", shortLabel: "범람", type: "flood", nodeId: "river", wave: 2, initialSeverity: 1, maxSeverity: 3, spreadAfterMs: 20_000, spreadsTo: ["bridge_damage"], allowedActions: ["lower_water"], requiredProgress: 100, scoreValue: 100, mapPosition: [790, 520], icon: "generator" },
