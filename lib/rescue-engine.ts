...
export const INCIDENTS: Record<IncidentId, IncidentDefinition> = {
  electrical_short: { id: "electrical_short", label: "전기 합선", shortLabel: "합선", type: "electrical", nodeId: "bakery_grid", wave: 1, initialSeverity: 2, maxSeverity: 3, spreadAfterMs: 18_000, spreadsTo: ["bakery_fire"], allowedActions: ["cut_power"], requiredProgress: 100, scoreValue: 100, mapPosition: [535, 228], icon: "generator" },
  bakery_fire: { id: "bakery_fire", label: "빵집 화재", shortLabel: "빵집", type: "fire", nodeId: "bakery", wave: 1, initialSeverity: 2, maxSeverity: 3, spreadAfterMs: 22_000, spreadsTo: ["gas_risk"], allowedActions: ["evacuate", "extinguish", "clear_debris", "firebreak"], requiredProgress: 100, scoreValue: 100, mapPosition: [390, 278], icon: "fire" },
  gas_risk: { id: "gas_risk", label: "가스 폭발 위험", shortLabel: "가스", type: "gas", nodeId: "bakery_gas", wave: 1, initialSeverity: 1, maxSeverity: 3, spreadAfterMs: 18_000, spreadsTo: ["house_fire"], allowedActions: ["shut_gas"], requiredProgress: 100, scoreValue: 100, mapPosition: [452, 340], icon: "fire" },
  power_flood: { id: "power_flood", label: "발전소 침수", shortLabel: "발전소", type: "flood", nodeId: "power_station", wave: 2, initialSeverity: 2, maxSeverity: 3, spreadAfterMs: 24_000, spreadsTo: ["river_overflow"], allowedActions: ["carry_parts", "repair_power"], requiredProgress: 100, scoreValue: 100, mapPosition: [928, 354], icon: "generator" },
  river_overflow: { id: "river_overflow", label: "하천 범람", shortLabel: "범람", type: "flood", nodeId: "river", wave: 2, initialSeverity: 1, maxSeverity: 3, spreadAfterMs: 20_000, spreadsTo: ["bridge_damage"], allowedActions: ["lower_water"], requiredProgress: 100, scoreValue: 100, mapPosition: [652, 503], icon: "generator" },
  bridge_damage: { id: "bridge_damage", label: "다리 파손", shortLabel: "다리", type: "bridge", nodeId: "bridge", wave: 2, initialSeverity: 2, maxSeverity: 3, spreadAfterMs: 22_000, spreadsTo: ["resident_isolation"], allowedActions: ["build_bridge"], requiredProgress: 100, scoreValue: 100, mapPosition: [770, 470], icon: "bridge" },
  resident_isolation: { id: "resident_isolation", label: "서쪽 주민 고립", shortLabel: "서쪽 주민", type: "rescue", nodeId: "west_house", wave: 2, initialSeverity: 1, maxSeverity: 3, spreadAfterMs: 26_000, spreadsTo: [], allowedActions: ["rescue_residents"], requiredProgress: 100, scoreValue: 100, mapPosition: [820, 330], icon: "cat" },
  house_fire: { id: "house_fire", label: "민가 확산 화재", shortLabel: "민가 화재", type: "fire", nodeId: "east_house", wave: 3, initialSeverity: 2, maxSeverity: 3, spreadAfterMs: 20_000, spreadsTo: ["east_residents"], allowedActions: ["clear_debris", "firebreak", "extinguish"], requiredProgress: 100, scoreValue: 100, mapPosition: [302, 372], icon: "fire" },
  cat_trapped: { id: "cat_trapped", label: "옥상 고양이 고립", shortLabel: "고양이", type: "rescue", nodeId: "cat_house", wave: 3, initialSeverity: 1, maxSeverity: 2, spreadAfterMs: 30_000, spreadsTo: [], allowedActions: ["rescue_cat"], requiredProgress: 100, scoreValue: 100, mapPosition: [885, 248], icon: "cat" },
  east_residents: { id: "east_residents", label: "동쪽 주민 고립", shortLabel: "동쪽 주민", type: "rescue", nodeId: "square", wave: 3, initialSeverity: 1, maxSeverity: 3, spreadAfterMs: 28_000, spreadsTo: [], allowedActions: ["rescue_residents"], requiredProgress: 100, scoreValue: 100, mapPosition: [548, 420], icon: "cat" },
};
