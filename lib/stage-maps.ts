...
export type StageMapDefinition = {
  ...
  routes?: Readonly<Partial<Record<LegacyIncidentId, readonly StagePoint[]>>>;
...
export const STAGE_MAPS: readonly StageMapDefinition[] = [
  classicMap("day", "푸른 구조 마을", "pp_stage_01_preview.webp"),
  {
    ...
    routes: {
      fire: [[410, 245], [610, 300], [790, 365], [945, 420]],
      generator: [[420, 230], [720, 230], [950, 230], [1065, 225]],
      bridge: [[410, 275], [540, 390], [688, 495]],
      cat: [[410, 230], [570, 190]],
    },
  ...
  },
  {
    ...
    routes: {
      fire: [[770, 250], [900, 215], [1020, 185]],
      generator: [[500, 285], [350, 330], [220, 375], [135, 420]],
      bridge: [[520, 295], [470, 355], [402, 402]],
      cat: [[800, 275], [950, 320], [1110, 345]],
    },
    legacyStructureOverlays: false,
  },
  {
    ...
    routes: {
      fire: [[790, 510], [915, 390], [1010, 270], [1045, 170]],
      generator: [[520, 490], [420, 410], [300, 330], [180, 245]],
      bridge: [[640, 490], [640, 450]],
      cat: [[790, 500], [900, 455], [995, 420]],
    },
    legacyStructureOverlays: false,
  },
  {
    ...
    routes: {
      fire: [[350, 250], [480, 185]],
      generator: [[390, 320], [600, 350], [800, 405], [1050, 505]],
      bridge: [[420, 325], [620, 360], [805, 400]],
      cat: [[395, 245], [550, 210], [685, 185]],
    },
    legacyStructureOverlays: false,
  },
