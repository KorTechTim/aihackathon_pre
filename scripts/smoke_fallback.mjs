...
await page.route("**/api/plan", (route) => fulfillPlan(route, ["fire", "bridge", "cat", "generator"], "fallback"));
...
console.log("Fallback smoke PASSED: OCI unavailable proxy response → LOCAL → full success");
