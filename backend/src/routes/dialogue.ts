...
import { DIALOGUE_SITUATIONS, type DialogueInput } from "../schemas/dialogue.js";
...
const bodySchema = {
  ...
  properties: {
    ...
    choiceIds: { type: "array", minItems: 2, maxItems: 3, uniqueItems: true, items: { type: "string", minLength: 2, maxLength: 40 } },
