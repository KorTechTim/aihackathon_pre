...
import { DIALOGUE_SITUATIONS, NPC_DIALOGUE_SITUATIONS, type DialogueInput } from "../schemas/dialogue.js";
...
const bodySchema = {
  ...
  allOf: [{
    ...
    then: { properties: { speaker: { const: "주민" }, choiceIds: { type: "array", maxItems: 0 } } },
