...
const bodySchema = {
  ...
  properties: {
    ...
    resolvedIncidents: { type: "array", maxItems: NEWS_INCIDENT_LABELS.length, uniqueItems: true, items: { type: "string", enum: [...NEWS_INCIDENT_LABELS] } },
    unresolvedIncidents: { type: "array", maxItems: NEWS_INCIDENT_LABELS.length, uniqueItems: true, items: { type: "string", enum: [...NEWS_INCIDENT_LABELS] } },
